        ...
        try:
            ...
            if "." in user_input:
                ...
                if len(decimal_part) > 2:
                    print("Please enter a positive number with no more than 2 decimal places.")
                    continue
...
def get_height():
    while True:
        height = get_positive_decimal("Please enter your height in centimetres: ")
...
def get_weight():
    while True:
        weight = get_positive_decimal("Please enter your weight in kilograms: ")
...
def main():
    ...
    print(f"BMI = {weight_kg:.2f} / ({height_m:.2f} x {height_m:.2f})")
    print(f"BMI = {bmi:.2f}")
